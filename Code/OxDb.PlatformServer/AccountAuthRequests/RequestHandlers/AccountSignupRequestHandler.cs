...
{
    public class AccountSignupRequestHandler : BaseAccountAuthRequestHandler<AccountSignupRequest>
    {
        protected override async Task HandleRequestInternal(IWebContext context, AccountSignupRequest request, CancellationToken token)
        {
            if (request == null)
            {
            ...
            else if (account == null)
            {
                ...
                string newId = await _accountService.GetNewUserId();
                account = new Account()
                {
                    Id = newId,
                    Name = request.Name,
        ...
        protected bool EmailIsOk(IWebContext context, string email)
        {
        ...
        protected bool NameIsOk(IWebContext context, string screenName)
        {
        ...
        protected bool ShareIdIsOk(IWebContext context, string shareId)
        {
        ...
        protected bool NewPasswordIsOk(IWebContext context, string password)
        {
