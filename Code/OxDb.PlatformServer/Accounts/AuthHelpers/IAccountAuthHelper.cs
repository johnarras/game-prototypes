...
{
    public interface IAccountAuthHelper : ISetupDictionaryItem<EAuthTypes>
    {
        Task<AccountAuthResult> CheckAuthAsync(IWebContext context, IAccountAuthRequest request);
    }
}
