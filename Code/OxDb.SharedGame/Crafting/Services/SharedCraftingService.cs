...
namespace OxDb.SharedGame.Crafting.Services
{
    ...
    public class SharedCraftingService : ISharedCraftingService
    {
        ...
        public virtual CraftingStats CalculateStatsFromReagents(Character ch, CraftingItemData data)
        {
            ...
            CraftingSettings craftingSettings = _gameData.Get<CraftingSettings>(ch);
            ...
            double levelStatAmount = craftingSettings.BaseStat;
            ...
            stats.Level = (int)Math.Floor(averageLevel);
