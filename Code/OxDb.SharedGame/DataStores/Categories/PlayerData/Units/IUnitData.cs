...
namespace OxDb.SharedGame.DataStores.Categories.PlayerData.Units
{
    ...
    [Union(41 ,typeof(OxDb.SharedGame.Currencies.PlayerData.CharCurrencyDto))]
    ...
    [Union(64 ,typeof(OxDb.SharedGame.Ads.PlayerData.AdsData))]
    [Union(65 ,typeof(OxDb.SharedGame.Ads.PlayerData.AdsDataDto))]
    [Union(66 ,typeof(OxDb.SharedGame.Achievements.PlayerData.AchievementData))]
    [Union(67 ,typeof(OxDb.SharedGame.Achievements.PlayerData.AchievementDto))]
    ...
    public interface IUnitDataLookup
    {
        ...
        IRandom Rand { get; }
        ValueTask<T> GetAsync<T>() where T : class, IUnitData, new();
        void AddResponse(IWebResponse response);
        ValueTask<IFilteredObject> GetFilteredObject(); // Returns CoreData or this thing itself.
    }
}
