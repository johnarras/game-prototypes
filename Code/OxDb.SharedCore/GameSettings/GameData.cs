...
namespace OxDb.SharedCore.GameSettings
{
    ...
    public class GameData : IGameData
    {
        ...
        {
            if (obj == null || obj.AB == null || obj.AB.Items == null || _nameSettings == null)
            {
            ...
            ABItem item = obj.AB.Items.FirstOrDefault(x => x.SettingsId == settingsId);
