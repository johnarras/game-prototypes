...
namespace OxDb.SharedCore.Core.Entities
{
    ...
    public class ServiceLocator : IServiceLocator
    {
        ...
        public void SetExplicitType(Type interfaceType, object obj)
        {
            ...
            {
                _logService.Info("ServiceLocator added incompatible type: " + interfaceType.Name + " vs " + obj.GetType().Name);
                throw new Exception("ServiceLocator added incompatible type: " + interfaceType.Name + " vs " + obj.GetType().Name);
            }

            if (!interfaceType.IsInterface)
            {
                _logService.Info("ServiceLocator can only set Interfaces Not: " + interfaceType.Name + " ");
