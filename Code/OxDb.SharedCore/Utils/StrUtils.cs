...
namespace OxDb.SharedCore.Utils
{
    ...
    public static class StrUtils
    {
        ...
        public static string WriteCSVString(object obj)
        {
            if (obj == null)
            {
                return "";
        ...
        public static string ToSnakeCase(this string input)
        {
            ...
            // Match lowercase-to-uppercase transitions or letters-to-numbers
            string step1 = Regex.Replace(input, @"(?<!^)(?<![A-Z])([A-Z])", "_$1");

            // Match the end of an acronym sequence followed by a lowercase letter (e.g., JSONParser -> JSON_Parser)
            string step2 = Regex.Replace(step1, @"(?<=[A-Z])([A-Z][a-z])", "_$1");
