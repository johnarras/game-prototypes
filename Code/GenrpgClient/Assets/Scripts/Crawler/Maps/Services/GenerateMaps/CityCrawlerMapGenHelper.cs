...
namespace Assets.Scripts.Crawler.Maps.Services.GenerateMaps
{
    public class CityCrawlerMapGenHelper : BaseCrawlerMapGenHelper
    {
        ...
        public override async Task<NewCrawlerMap> Generate(PartyData party, CrawlerWorld world, CrawlerMapGenData genData, CancellationToken token)
        {
            ...
            bool[,] clearCells = AddCorridors(map, genData, rand, RandUtils.FloatRange(genType.MinCorridorDensity, genType.MaxCorridorDensity, rand));
            ...
            if (_optionsService.HasOption(party, CrawlerOptions.FullWorld))
            {
                ...
                if (rand.NextDouble() < 0.5f)
                {
                    ...
                    gateZ = RandUtils.IntRange(map.Height / 3, map.Height * 2 / 3, rand);
                ...
                else
                {
                    ...
                    gateX = RandUtils.IntRange(map.Width / 3, map.Width * 2 / 3, rand);
