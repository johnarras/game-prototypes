...
public class CrawlerStateData
{
    ...
    public string WorldSpriteName = null;
    public string BGSpriteName = null;
    ...
    public bool BGImageOnly { get; set; }
    public bool HideBigPanels { get; set; }
    public bool ClearBGImage { get; set; }
    ...
    {
        Actions.Add(new CrawlerStateAction(text));
    }
