...
namespace Assets.Scripts.Crawler.Shared.Spells.Helpers.EffectHelpers
{
    public abstract class BaseCrawlerSpellEffectHelper : ICrawlerSpellEffectHelper
    {
        ...
        public abstract ValueTask ApplyEffectToUnit(PartyData party, ApplyEffectArgs args, FullSpell spell, FullEffect fullEffect, CrawlerUnit caster, CrawlerUnit target, CancellationToken token);
    }
}
