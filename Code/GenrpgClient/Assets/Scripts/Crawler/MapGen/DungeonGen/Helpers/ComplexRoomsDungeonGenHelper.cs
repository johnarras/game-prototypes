...
{
    public class ComplexRoomsDungeonGenHelper : BaseDungeonGenHelper
    {
        public override long HelperKey => DungeonTypes.ComplexRooms;
        ...
        public override async ValueTask<bool> GenerateLevel(CrawlerMapGenData genData, DungeonLevelGenArgs levelArgs)
        {
            ...
            int wantedRoomCount = (levelArgs.Map.Width * levelArgs.Map.Height / (minSeparation * minSeparation)) / 3;
