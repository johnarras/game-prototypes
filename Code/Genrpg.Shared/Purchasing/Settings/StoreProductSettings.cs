...
namespace Genrpg.Shared.Purchasing.Settings
{
    ...
    public class StoreItemSettingsDto : ParentSettingsDto<StoreItemSettings, StoreItem> { }
    public class StoreItemSettingsLoader : ParentSettingsLoader<StoreItemSettings, StoreItem> 
    {
    }

    public class StoreItemSettingsMapper : ParentSettingsMapper<StoreItemSettings, StoreItem, StoreItemSettingsDto>
    {
