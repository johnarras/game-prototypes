...
namespace Genrpg.Shared.Crawler.Combat.Settings
{
    ...
    public class CrawlerCombatSettings : NoChildSettings // No List
    {
        ...
        [Key(23)] public double BaseMonsterRoleScalingTier { get; set; }
        [Key(24)] public double BasePlayerRoleScalingTier { get; set; }

        [Key(25)] public double SummonQuantityScale { get; set; }

        [Key(26)] public double CritScaledownPerHit { get; set; }

        [Key(27)] public double MonsterExtraHealthScalePerDay { get; set; }
        [Key(28)] public double MonsterExtraDamageScalePerDay { get; set; }

        [Key(29)] public int SpeedCombatSequencingDeltaPercent { get; set; }

        [Key(30)] public double ExtraCureStatusEffectsRemovedPerTier { get; set; }
    }
