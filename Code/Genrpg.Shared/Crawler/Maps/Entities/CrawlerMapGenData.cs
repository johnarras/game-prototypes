...
namespace Genrpg.Shared.Crawler.Maps.Entities
{
    ...
    public class CrawlerMapGenData
    {
        ...
        [Key(3)] public int LevelDelta { get; set; }
        ...
        [Key(8)] public int CurrFloor { get; set; } = 1;
        [Key(9)] public int MaxFloor { get; set; } = 1;
        ...
        [Key(19)] public List<ZoneUnitSpawn> SharedUnits { get; set; } = new List<ZoneUnitSpawn>();
        [Key(20)] public List<CurrentUnitKeyword> UnitKeywords { get; set; } = new List<CurrentUnitKeyword>();
    }
