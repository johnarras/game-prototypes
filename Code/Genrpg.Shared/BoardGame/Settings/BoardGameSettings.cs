...
namespace Genrpg.Shared.BoardGame.Settings
{
    ...
    public class BoardGameSettings : NoChildSettings // No List
    {
        ...
        [Key(4)] public string FavoriteSuperhero { get; set; }
    ...
    public class BoardGameSettingsDto : NoChildSettingsDto<BoardGameSettings> { }

    public class BoardGameSettingsMapper : NoChildSettingsMapper<BoardGameSettings, BoardGameSettingsDto> { }
}
