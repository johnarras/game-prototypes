...
namespace Genrpg.Shared.BoardGame.Settings
{
    ...
    public class Marker : ChildSettings, IIndexedGameItem
    {
        ...
        [Key(8)] public int MaxTier { get; set; }
        [Key(9)] public long QualityTypeId { get; set; }
    }

    public class MarkerSettingsDto : ParentSettingsDto<MarkerSettings, Marker> { }

    public class MarkerSettingsLoader : ParentSettingsLoader<MarkerSettings, Marker> { }

    public class MarkerSettingsMapper : ParentSettingsMapper<MarkerSettings, Marker, MarkerSettingsDto> { }

    public class MarkerEntityHelper : BaseEntityHelper<MarkerSettings, Marker>
    {
        public override long Key => EntityTypes.Marker;
    }
}
