...
namespace Genrpg.Shared.BoardGame.Activations.Settings
{
    ...
    public class ActivationSettings : NoChildSettings // No List
    {
        ...
        public int GetMaxCharge(int level, double activationCostScale)
        {
    ...
    public class ActivationSettingsDto : NoChildSettingsDto<ActivationSettings> { }

    public class ActivationSettingsMapper : NoChildSettingsMapper<ActivationSettings, ActivationSettingsDto> { }
}
