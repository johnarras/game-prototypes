...
namespace Genrpg.Shared.Crafting.Settings.Crafters
{
    ...
    public class CrafterType : ChildSettings, IIndexedGameItem
    {
        ...
        [Key(8)] public string MousePointer { get; set; }

        [Key(9)] public long ReagentItemTypeId { get; set; }

        [Key(10)] public float GatherSeconds { get; set; }
        [Key(11)] public float CraftingSeconds { get; set; }
        [Key(12)] public string GatherActionName { get; set; }
        [Key(13)] public string CraftActionName { get; set; }
        [Key(14)] public string GatherAnimation { get; set; }
        [Key(15)] public string CraftAnimation { get; set; }
    }
