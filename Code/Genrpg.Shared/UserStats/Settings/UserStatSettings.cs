...
namespace Genrpg.Shared.UserStats.Settings
{
    ...
    public class UserStatSettingsDto : ParentSettingsDto<UserStatSettings, UserStatType> { }
    public class UnitCoinSettingsLoader : ParentSettingsLoader<UserStatSettings, UserStatType> { }

    public class UserStatSettingsMapper : ParentSettingsMapper<UserStatSettings, UserStatType, UserStatSettingsDto> { }
}
