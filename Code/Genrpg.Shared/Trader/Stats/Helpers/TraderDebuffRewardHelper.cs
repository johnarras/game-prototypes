...
{
    public class TraderDebuffRewardHelper : IRewardHelper
    {
        ...
        public long GetQuantity(MapObject obj, long entityId)
        {
            ...
            return _statService.GetDebuffDays(coreData, caravanData, statData, entityId);
        }
        ...
        public bool GiveReward(IRandom rand, MapObject obj, long entityId, long quantity, object extraData, RewardParams rp)
        {
            ...
            _statService.AddDebuff(coreData, caravanData, statData, entityId, quantity);
