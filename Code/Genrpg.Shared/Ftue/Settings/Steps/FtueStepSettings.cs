...
namespace Genrpg.Shared.Ftue.Settings.Steps
{
    ...
    public class FtueStep : ChildSettings, IIndexedGameItem
    {
        ...
        [Key(8)] public long PrereqFtueStepId { get; set; }
        [Key(9)] public long FtueTriggerId { get; set; }

        [Key(10)] public string TriggerName { get; set; }

        // If this exists, open this screen
        [Key(11)] public string ActionScreenName { get; set; }

        // If this exists, this is the only button we can click
        [Key(12)] public string ActionButtonName { get; set; }

        /// <summary>
        /// Do we show the popup tint or hide the popup
        /// </summary>
        [Key(13)] public long FtuePopupTypeId { get; set; }
