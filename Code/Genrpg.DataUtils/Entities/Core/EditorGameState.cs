...
namespace Genrpg.DataUtils.Entities.Core
{
    public delegate Task OnEditorClickAction(EditorGameState gs, IEditorDataService gameDataService, CancellationToken token);
