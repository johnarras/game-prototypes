using OxDb.PlayerServer.Entities;
...
namespace OxDb.PlayerServer.Managers
{
    ...
    public class PlayerService : IPlayerService
    {
        ...
        {
            _logService.Info("LoginUser: " + login.Id + ": " + login.Name);
        ...
        {
            _logService.Info("Logout user: " + logout.Id);
        ...
        protected void RemoveFromZone(OnlineCharacter currChar)
        {
            if (currChar.ZoneId > 0)
            {
                ...
                {
                    _logService.Info("RemoveFromZone: " + currChar.Id);
        ...
        {
            _logService.Info("PlayerEnterMap: " + playerEnterMap.Id + " Map: " + playerEnterMap.MapId + " Instance: " +
        ...
        {
            _logService.Info("PlayerLeaveMap: " + playerLeaveMap.Id);
        ...
        {
            _logService.Info("AddToZone: " + playerEnterZone.Id + " to " + playerEnterZone.ZoneId);
        ...
        public void OnGetWhoList(WhoListRequest request)
        {
            ...
            _commsService.SendQueueMessage(request.FromServerName, response);
